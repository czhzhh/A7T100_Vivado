...
HD_PWD='/home/parallels/A7T100_Vivado/A7T100_Vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Ece253_BlockDesign_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Ece253_BlockDesign_wrapper.tcl
